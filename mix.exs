    ...
    [
      ...
      groups_for_modules: [
        Core: [
          ...
          OxideApi.Ash.Disk,
          OxideApi.Ash.Domain,
          OxideApi.Ash.FloatingIp,
          OxideApi.Ash.Image,
          OxideApi.Ash.Instance,
          OxideApi.Ash.Project,
          OxideApi.Cache,
          OxideApi.Job,
          OxideApi.ManagedClient,
          OxideApi.Oban.ProvisionInstanceWorker,
          OxideApi.Oban.RequestOperationWorker,
          OxideApi.Oban.WaitForInstanceWorker,
          OxideApi.Operation,
          OxideApi.Oxql,
          OxideApi.Oxql.Point,
